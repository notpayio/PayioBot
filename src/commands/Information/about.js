...
Do you wanna make your server more active and chill with some cool bot!`)
        ...
        .setFooter({text: `Requested by ` + message.author.username , iconURL: message.author.displayAvatarURL({ dynamic: true })})
            .addFields([{ name: '**__Developers__**', value: '**[Payio.real](https://discord.com/users/1086873202296365057)**', inline: true },
                        
  { name: '**__Owners__**', value: '**[WD KAMINA YT](https://discord.com/users/713338907999076373)**',  inline: true },              
            ]);
