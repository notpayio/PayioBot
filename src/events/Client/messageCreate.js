...
module.exports = {
    ...
    .setTitle("**__Hey! I'm a Rizz Bot__**")
    .setDescription(`A Very Good Moderation With Cool Features`)
    .addFields([
            { name: '**__Thanks For Pinging__**', value: `<a:dot:1292973935553413120> Browse my commands by using \`${prefix}help\`
<a:dot:1292973935553413120> Join [MF Community](https://discord.gg/mfop) to get updates related to Rizz.`, inline: true },
