...
.setColor(client.color)
    .setTitle('<a:developer:1064146782923280394> **__Rizz Owner__**')
    .setDescription("**1. [wdkaminayt]](https://discord.com/users/713338907999076373)**");
    const emb2 = new EmbedBuilder()
.setColor(client.color)
    .setTitle('<:OWNER:1075867536199012423> **__Bot Owners__**')
    .setDescription("**1. [wdkaminayt](https://discord.com/users/713338907999076373)**\n**2. [Vishu](https://discord.com/users/992471153182527639)**")
